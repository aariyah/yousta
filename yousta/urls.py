...
,ClothCreateView,ClothListView,ClothUpdateView,remove_clothview,ClothVarientCreateView,\
    ClothDetailView,ClothVarientUpdateView,remove_varient,OfferCreateView,remove_offer,sign_out_view,IndexView
...
urlpatterns=[
    ...
    path("offers/<int:pk>/remove",remove_offer,name="offer-remove"),
